  ...
  render() {
    return (
      <div className="Home">
        ...
        <h2>Yes, we know how to spell "todo", but you'll be so amazed by what you'll accomplish you'll be shouting "TADA" down the isles of your local supermarket.</h2>
